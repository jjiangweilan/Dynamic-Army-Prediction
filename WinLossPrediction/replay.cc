...
//#include "json.hpp"
#include "/Users/tejapathakota/Downloads/json.hpp" // the json hpp

//put your replay folder here
const char* kReplayFolder = "/Users/tejapathakota/Desktop/REPLAY/";
    ...
    void OnGameStart() final {
        ...
        void OnUnitCreated(const sc2::Unit* unit) final {
            ...
            if (iter != unitsc.end()) {
                ...
                arrayTime[sc2::UnitTypeToName(unit->unit_type)].push_back(observation->GetUnit(unit->tag)->health);
